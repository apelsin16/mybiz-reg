...
export default  class DeputyDirector extends Component {
  ...
  handleSaveDeputyDirector = (e) => {
    e.preventDefault();
    this.props.onSaveDeputyDirector(this.state);
  };
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        />
        <div className='row__wrapper'>
          <button className='minjust-link' onClick={e=>this.handleSaveDeputyDirector(e)}>Зберегти дані</button>
        </div>
      </Fragment>
    );
  }
